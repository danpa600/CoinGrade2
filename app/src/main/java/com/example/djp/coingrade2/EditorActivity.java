...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    /** track if any edits have been made to any input field **/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentSeriesUri == null) {
            ...
            setTitle(getString(R.string.editor_activity_title_edit_coin_series));
        ...
        mBreedEditText = (EditText) findViewById(R.id.edit_notes);
    ...
    private void savePet() {
        ...
        // TODO fix this entry - if nothing entered this fails.
        if (validInputs(nameString)) {
            ...
            Toast.makeText(this, getString(R.string.editor_insert_validation_failed), Toast.LENGTH_LONG).show();
        }
    }

    private boolean validInputs(String nameString) {
        boolean returnValue = false;
        if (!nameString.isEmpty() && nameString.length() < 30){
                returnValue = true;
        }
        return returnValue;
    }
